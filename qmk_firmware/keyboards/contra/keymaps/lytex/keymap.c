...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
    ...
    KC_ESC, KC_NO, OSM(MOD_LGUI), OSM(MOD_LALT), OSL(2), KC_SPC, KC_SPC, OSL(1), OSM(MOD_RALT), KC_NO, KC_NO, KC_NO),
	[1] = LAYOUT_ortho_4x12(
    ...
    KC_ESC, KC_NO, OSM(MOD_LGUI), OSM(MOD_LALT), OSL(2), KC_SPC, KC_SPC, KC_TRNS, OSM(MOD_RALT), KC_NO, KC_NO, KC_NO),
    ...
    KC_ESC, KC_NO, OSM(MOD_LGUI), OSM(MOD_LALT), KC_TRNS, KC_NO, KC_NO, OSL(1), OSM(MOD_RALT), KC_NO, KC_NO, KC_NO)
};
