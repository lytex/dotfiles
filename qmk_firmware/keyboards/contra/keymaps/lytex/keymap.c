...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
    ...
    KC_ESC, KC_NO, KC_LGUI, KC_LALT, TT(2), KC_SPC, KC_SPC, TT(1), KC_RALT, KC_NO, KC_NO, KC_NO),
	[1] = LAYOUT_ortho_4x12(
    ...
    KC_ESC, KC_NO, KC_LGUI, KC_LALT, TT(2), KC_SPC, KC_SPC, KC_TRNS, KC_RALT, KC_NO, KC_NO, KC_RCTL),
    ...
    KC_LSFT, KC_BRID, KC_BRIU, KC_NO, KC_NO, KC_MUTE, KC_VOLD, KC_VOLU, KC_MRWD, KC_MPLY, KC_MFFD, KC_RSFT, KC_ESC, KC_NO, KC_LGUI, KC_LALT, KC_TRNS, KC_NO, KC_NO, TT(1), KC_RALT, KC_NO, KC_NO, KC_NO)
};
