...
enum contra_layers { _QWERTY, _INVERSE_QWERTY, _SHIFTED_INVERSE_QWERTY, _ALTGR_INVERSE_QWERTY, _ALTGR_SHIFTED_INVERSE_QWERTY, _NUMBER_INVERSE_QWERTY, _NUMBER_SHIFTED_INVERSE_QWERTY, _NUMBER, _NAVIGATION, _STENO };
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * `------------------------------------------------------------------------------------'
     */
    [_QWERTY] = LAYOUT_ortho_4x12(KC_TAB, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_BSPC, OSM(MOD_LCTL), KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT, OSM(MOD_LSFT), KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, OSM(MOD_RSFT), KC_ESC, IQWERT, RGB_TOG, OSM(MOD_LGUI), OSM(MOD_LALT), NAV, KC_SPC, NUM, OSM(MOD_RALT), RGB_MOD, STENO, QWERTY),
    /******************************************************************************************************************/
